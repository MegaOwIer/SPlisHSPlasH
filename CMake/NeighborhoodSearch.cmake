...
if(USE_GPU_NEIGHBORHOOD_SEARCH)
	...
	ExternalProject_Add(
	   ...
	   PREFIX "${CMAKE_BINARY_DIR}/extern/cuNSearch"
	   ...
	   PATCH_COMMAND perl -0pi -e "s/set\\(CMAKE_CXX_STANDARD 11\\)\\nset\\(CMAKE_CXX_STANDARD_REQUIRED ON\\)/set(CMAKE_CXX_STANDARD 14)\\nset(CMAKE_CXX_STANDARD_REQUIRED ON)\\nset(CMAKE_CUDA_STANDARD 14)\\nset(CMAKE_CUDA_STANDARD_REQUIRED ON)/" <SOURCE_DIR>/CMakeLists.txt
	   INSTALL_DIR ${ExternalInstallDir}/NeighborhoodSearch
	   CMAKE_ARGS -DCMAKE_BUILD_TYPE=${EXT_CMAKE_BUILD_TYPE} -DCMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS} -DCMAKE_CXX_FLAGS_RELEASE=${CMAKE_CXX_FLAGS_RELEASE} "-DCMAKE_CUDA_FLAGS=-U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=0" -DCMAKE_CUDA_ARCHITECTURES=${CMAKE_CUDA_ARCHITECTURES} -DCMAKE_INSTALL_PREFIX:PATH=${ExternalInstallDir}/NeighborhoodSearch -DCUNSEARCH_USE_DOUBLE_PRECISION:BOOL=${USE_DOUBLE_PRECISION} -DBUILD_DEMO:BOOL=OFF
	   )
